...
<main class="form-signin">
  <form method="post" action="loginAction.jsp">
    ...
    <a class="mt-5 mb-3 text-muted" href="join.jsp" style="font-size: 20px; font-weight: bold; text-decoration: none;"><span style="border-bottom: 12px solid #dcf1fb; padding: 0 0 0 0.2em;">Sign up</span></a>
